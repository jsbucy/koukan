...
class FilterChainFactory:
    ...
    # Returns a fully-populated Sender corresponding to sender.name
    # and sender.tag if any, else None
    def get_sender(self, sender : Sender) -> Optional[Sender]:
        assert sender.name is not None
