...
INSERT INTO Transactions (id, rest_id, json, status, inflight_session_id, creation, last_update, last, version) VALUES (12345, "xyz", '{"mail_from": {"m":"alice@example.com"}, "host": "outbound-gw"}', 1, 100, 1, 1, true, 0);
