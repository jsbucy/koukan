...
INSERT INTO Transactions (id, rest_id, json, status, inflight_session_id, creation, last_update, last, version) VALUES (12345, "xyz", '{"mail_from": "alice@example.com"}', 2, 100, 1, 1, true, 0);
